...
p.DCr2O3 = p.DCr2O3O;  p.DFe3O4 = 0.0012;  p.DFeCr2O4 = 0.0006;  p.DSiO2 = 1.5;
 
% ---- 界面动力学 (nm/s) ----
p.kCr = 0.2;  p.kSi = 2e-5;  p.kFe = 1e-5;  p.kspin = 5e-4;
 
% ---- 热力学门控 (无量纲; 默认全关) ----
p.E_Si = 0;  p.E_Cr = 0;  p.E_mag = 0.00033;  p.E_spin = 0;
p.kRobin = 1.5;
